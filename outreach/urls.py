...
urlpatterns = [
    ...
    url(r'^concept/(?P<short_title>[a-zA-Z]+-[a-zA-Z]+)/$',article,{'resource_type':'concept'},name="concept_article"),
    ...
    url(r'^pictures/key/(?P<key>[a-z]+)/$',list_resources,{'resource_type':'pictures'},name='pictures_key'),
    url(r'^pictures/key/(?P<key>[a-z]+\+[a-z]+)/$',list_resources,{'resource_type':'pictures'},name='pictures_key'),
    ...
    url(r'^movies/key/(?P<key>[a-z]+)/$',list_resources,{'resource_type':'movies'},name='movies_key'),
    url(r'^movies/key/(?P<key>[a-z]+\+[a-z]+)/$',list_resources,{'resource_type':'movies'},name='movies_key'),
