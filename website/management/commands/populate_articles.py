...
from website.models import ConceptPage, TutorialPage, SitePage, InteractiveTool
import glob
...
class Command(BaseCommand):
    ...
    def _create_article_entries(self,*args, **options):
        ...
        for raw_file in file_list:
            ...
            file_lines = open(raw_file,'r').readlines()
    ...
    def _parse_raw_file_header(self,file_lines):
        header = {}
